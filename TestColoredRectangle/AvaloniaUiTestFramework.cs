...
[assembly: TestFramework("TestColoredRectangle.AvaloniaUiTestFramework", "TestColoredRectangle")]
			...
			var thread = new Thread(() =>
			{
				try {
					...
					_ = AvaloniaApp
							.BuildAvaloniaApp()
							.AfterSetup(_ => {
								tcs.SetResult(SynchronizationContext.Current ?? throw new ArgumentNullException());
							})
